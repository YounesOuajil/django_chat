...
//     await peer.setRemoteDescription(new RTCSessionDescription(data.offer));
//     console.log(
//       "----Remote description of the answer is set",
...
//     await peer.setLocalDescription(new RTCSessionDescription(answer));
//     console.log(
//       "---local descriptison of the answer is set",
//       peer.localDescription
//     );
//     try {
//       console.log(
//         "websoket status is BEFOR the ensur websoket open ",
//         socket.state
//       );
//       await ensureWebSocketOpen(socket);
//       console.log(
//         "websoket status is AFTER the ensur websoket open ",
//         socket.state
//       );
//       if (socket && socket.readyState === WebSocket.OPEN) {
//         console.log("Socket is open", socket.state);
//         socket.send(
//           JSON.stringify({ type: "answer", answer: peer.localDescription })
//         );
//         console.log("Sent answer");
...
//     try {
//       console.log("-----------befor the set remot created ");
//       await peer.setRemoteDescription(new RTCSessionDescription(data.answer));
//       console.log(
//         "------------after the set remot created ",
//         peer.setRemoteDescription
//       );
//       console.log(
//         "----Remote description of the caller is set",
//         peer.remoteDescription
//       );
//     } catch (err) {
...
//    const soketconection = (senderId, receiverId) => {
//      if (socket && socket.connected) {
//        console.log("soket alredy open");
//        return socket;
//      } else {
//        const newSocket = new WebSocket(
//          `ws://localhost:8000/ws/chat/${senderId}/${receiverId}/`
...
//          setSocket(newSocket);
//        };
//        console.log("soket created ", newSocket);
...
//   useEffect(() => {
//      const newSocket = soketconection(senderId, receiverId);
//       newSocket.onmessage = handleSocketMessage;
...
//   const answer = await peer.createAnswer();
//   await peer.setLocalDescription(new RTCSessionDescription(answer));
//   console.log("---the answer local description is set successfully",peer.localDescription);

//   try {
//     const socket = soketconection(senderId, receiverId);
//     console.log("Socket created", socket);
...
//      } else {
//        console.warn(
//          "Cannot set remote description in the current signaling state:",
//          peer.signalingState
//        );
//      }
//    } catch (err) {
...
//     const peer = await initializePeerConnection();
//     console.log(
//       "the staus of myremot description in the start call is ",
//       peer.signalingState
//     );
//     const offer = await peer.createOffer();
//     await peer.setLocalDescription(new RTCSessionDescription(offer));
...
//     const peer = await initializePeerConnection();
//     console.log(
//       "the staus of myremot description in the handlin offer  is",
//       peer.signalingState
//     );
//     await peer.setRemoteDescription(new RTCSessionDescription(data.offer));
//     console.log(
...
//     const peer = peerConnectionRef.current;
//     console.log(
//       "the staus of myremot description in the handling answer is",
//       peer.signalingState
//     );
